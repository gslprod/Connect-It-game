...
{
    public class RemoveConnectionsTutorial : IInitializable
    {
        ...
        public RemoveConnectionsTutorial(
        ...
        {
            return
                _gameplayLogicConfig.CurrentLevel == 2 &&
                _levelsPassDataProvider.GetDataByLevelId(2).NotCompleted;
        }
        ...
        private void Start()
        {
            ...
            {
                new(_textKeyFactory.Create(TextKeysConstants.Gameplay.Tutorial.RemoveConnections_MainDialogBox_Title),
                    _textKeyFactory.Create(TextKeysConstants.Gameplay.Tutorial.RemoveConnections_MainDialogBox_Message))
            };
