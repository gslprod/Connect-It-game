...
{
    public static class TemplatesNameConstants
    {
        public static class Product
        {
            public const string NameLabel = "product-name";

            public const string DescriptionContainerButton = "product-decription-container";
            public const string DescriptionLabel = "product-description-label";

            public const string AmountLabel = "product-amount";
            public const string PriceLabel = "product-price";
            public const string BuyButton = "product-buy";
        }
