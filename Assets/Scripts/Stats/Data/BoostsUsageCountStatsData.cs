...
{
    public class BoostsUsageCountStatsData : StatsDataBase<long>, IInitializable
    {
        ...
        public BoostsUsageCountStatsData(
        ...
        {
            _name = _textKeyFactory.Create(TextKeysConstants.StatsData.BoostsUsageCount_Name);
            _description = _textKeyFactory.Create(TextKeysConstants.StatsData.BoostsUsageCount_Description);
            _value = _textKeyFactory.Create(TextKeysConstants.StatsData.BoostsUsageCount_Value);
        ...
        public class Factory : PlaceholderFactory<BoostsUsageCountStatsData> { }
    }
}
