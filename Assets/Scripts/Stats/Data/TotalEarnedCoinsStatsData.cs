...
{
    public class TotalEarnedCoinsStatsData : StatsDataBase<long>, IInitializable
    {
        ...
        public TotalEarnedCoinsStatsData(
        ...
        {
            _name = _textKeyFactory.Create(TextKeysConstants.StatsData.TotalEarnedCoins_Name);
            _description = _textKeyFactory.Create(TextKeysConstants.StatsData.TotalEarnedCoins_Description);
            _value = _textKeyFactory.Create(TextKeysConstants.StatsData.TotalEarnedCoins_Value);
        ...
        public class Factory : PlaceholderFactory<TotalEarnedCoinsStatsData> { }
    }
}
