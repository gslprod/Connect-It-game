...
{
    public class PassedLevelsTimeSumStatsData : StatsDataBase<double>, IInitializable
    {
        ...
        public PassedLevelsTimeSumStatsData(
        ...
        {
            _name = _textKeyFactory.Create(TextKeysConstants.StatsData.PassedLevelsTimeSum_Name);
            _description = _textKeyFactory.Create(TextKeysConstants.StatsData.PassedLevelsTimeSum_Description);
            _value = _textKeyFactory.Create(TextKeysConstants.StatsData.PassedLevelsTimeSum_Value);
        ...
        public class Factory : PlaceholderFactory<PassedLevelsTimeSumStatsData> { }
    }
}
